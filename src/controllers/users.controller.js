...
export const getUsers = async (req, res) => {
  ...
  return res.status(200).send({ totalUsers: users.length, users });
    ...
    return res
    .status(500)
    .send({ message: "Erro ao buscar usuarios", error: error.message });
  }
};
...
export const getUserById = async (req, res) => {
  ...
  return res.status(200).send({ message: "Usuário encontrado", user });
    ...
    return res
    .status(500)
    .send({ message: "Erro ao buscar usuario por id", error: error.message });
}
};
...
export const createUser = async (req, res) => {
  ...
  return res.status(201).send({ message: "Usuário criado com sucesso", user });
    ...
    return res
    .status(500)
    .send({ message: "Erro ao criar usuario", error: error.message });
}
};
...
export const updateUser = async (req, res) => {
  ...
  return res
    ...
    return res
    .status(500)
    .send({ message: `Erro ao atualizar usuario com ${id}`, error: error.message });
}
};
...
export const deleteUser = async (req, res) => {
  ...
  return res
    ...
    return res
    .status(500)
    .send({ message: `Erro ao deletar usuario com id ${id}`, error: error.message });
}
};
